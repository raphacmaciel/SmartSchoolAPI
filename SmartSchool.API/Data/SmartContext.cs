        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Aluno>()
                .HasData(new List<Aluno>(){
                    new Aluno(1, 1, "Marta", "Kent", "33225555", DateTime.Parse("10/11/1988")),
                    new Aluno(2, 2, "Paula", "Isabela", "3354288", DateTime.Parse("31/10/2005")),
                    new Aluno(3, 3, "Laura", "Antonia", "55668899", DateTime.Parse("31/05/2005")),
                    new Aluno(4, 4, "Luiza", "Maria", "6565659", DateTime.Parse("02/06/2005")),
